...
users = []
users.append(User(id=1, username='yahia', password='XXX'))
users.append(User(id=2, username='seif', password='XXX'))
users.append(User(id=3, username='youssef', password='XXX'))
...
#breach_dir
            ...
            headers = {
                'x-rapidapi-key': "23f818a418msh1cba40f222a515dp1d76fejsn8b44db0914be",
                'x-rapidapi-host': "breachdirectory.p.rapidapi.com"
                }

            resp = requests.request("GET", url, headers=headers, params=querystring)
            resp = "Plain Text password" + resp.text
...
#breach dir 
# 
        #filtering the domain name 
            term = uname
            stopwords = ['.', 'edu', 'eg','.edu.eg']
        ...
        #sending request to breach dir

            url = "https://breachdirectory.p.rapidapi.com/"

            querystring = {"func":"auto","term":result}
            ...
            response = 'all passwords containing   ' + '\n' +response.text
